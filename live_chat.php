<?php
    ...
    if (isset($_POST['usermsg'])) {
        ...
        $responsevar = send_msg($user_msg, $usern);
        echo $responsevar;
    }
			...
			<td align="center">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<td>
						...
						<tr align="center"><h5>Welcome to SUConcert Database Support Page</h5></tr>
...
if (isset($_POST['dropDown'])){
	$user_subj = $_POST['dropDown'];

	echo '
	<div cellpadding="5" cellspacing="10">
		<table align="center">
			<tr>
				<td align="center">
	...
	<tr>
		<td align="right">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<td>
					<tr>
						<form name="form" action = "live_chat.php" method="POST">
							<select id="dropDown" name="dropDown">
								<option value="invalid insertion to database">invalid insertion to database</option>
								<option value="invalid deletion from database">invalid deletion from database</option>
								<option value="invalid relation insertion to database">invalid relation insertion to database</option>
								<option value="other">other</option>
							 </select>
							<input name="usermsg" type="text" placeholder="Type here!"/>
							<input name="username" type="text" placeholder="Type your name here!"/>
